...
export const DEMO_TEMPLATES: DemoTemplate[] = [
...

  {
    ...
    description:
      "Product information with pricing, suppliers, and specifications",
...

  {
    ...
    description:
      "Customer segment data with pricing tiers and account managers",
 ...
 */
export function generateSampleInputData(
  templateId: string
): Record<string, any>[] {
