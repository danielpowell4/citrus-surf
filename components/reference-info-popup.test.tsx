...
const mockReferenceData = [
  { department_name: 'Engineering', department_id: 'ENG', manager_name: 'John Smith', budget: 1000000 },
  { department_name: 'Marketing', department_id: 'MKT', manager_name: 'Jane Doe', budget: 500000 },
  { department_name: 'Sales', department_id: 'SAL', manager_name: 'Bob Johnson', budget: 750000 },
  { department_name: 'Human Resources', department_id: 'HR', manager_name: 'Alice Brown', budget: 300000 },
  { department_name: 'Finance', department_id: 'FIN', manager_name: 'Charlie Wilson', budget: 400000 },
];
...
describe('ReferenceInfoPopup', () => {
  ...
  describe('Trigger Button', () => {
    it('renders info button with proper accessibility attributes', () => {
      ...
      expect(trigger).toHaveAttribute('aria-label', 'View reference data information');
      expect(trigger).toHaveAttribute('title', 'View reference data information');
    });
  ...
  describe('Sample Values Display', () => {
    it('truncates long values with ellipsis', async () => {
      const longValueData = [
        { department_name: 'This is a very long department name that should be truncated', department_id: 'LONG' },
      ];
  ...
  describe('Action Buttons', () => {
    it('shows View Data button when onReferenceView is provided', async () => {
      ...
      const viewButton = await screen.findByRole('button', { name: /view data/i });
    ...
    it('shows Edit Values button when allowReferenceEdit is true and onReferenceEdit is provided', async () => {
      ...
      const editButton = await screen.findByRole('button', { name: /edit values/i });
    ...
    it('does not show Edit Values button when allowReferenceEdit is false', async () => {
      ...
      const lookupFieldNoEdit = { ...mockLookupField, allowReferenceEdit: false };
      renderComponent({ lookupField: lookupFieldNoEdit, onReferenceEdit: mockOnReferenceEdit });
